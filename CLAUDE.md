...
ОС, установки zsh-стека, tmux-стека, личных алиасов и CLI-инструментов
нового поколения. Остальное (git-экосистема без gh, docker, tldr,
neofetch, базовый набор пакетов, install.sh-лаунчер) ещё не написано.
